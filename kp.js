(function () {
  ...
  function main() {
    ...
    var parts_data = [
      ...
      function (call) {
        getList(
          "api/v2.2/films/top?type=TOP_250_BEST_FILMS",
          params,
          function (json) {
      ...
      function (call) {
        getList(
          "api/v2.2/films?order=NUM_VOTE&type=FILM",
          params,
          function (json) {
      ...
      function (call) {
        getList(
          "api/v2.2/films?order=NUM_VOTE&type=TV_SERIES",
          params,
          function (json) {
      ...
      function (call) {
        getList(
          "api/v2.2/films?order=NUM_VOTE&type=MINI_SERIES",
          params,
          function (json) {
      ...
      function (call) {
        getList(
          "api/v2.2/films?order=NUM_VOTE&type=TV_SHOW",
          params,
          function (json) {
    ...
    menu({}, function () {
      ...
      if (rus_id) {
        parts_data.splice(3, 0, function (call) {
          getList(
            "api/v2.2/films?order=NUM_VOTE&countries=" + rus_id + "&type=FILM",
            params,
            function (json) {
        ...
        parts_data.splice(5, 0, function (call) {
          getList(
            "api/v2.2/films?order=NUM_VOTE&countries=" + rus_id + "&type=TV_SERIES",
            params,
            function (json) {
        ...
        parts_data.splice(7, 0, function (call) {
          getList(
            "api/v2.2/films?order=NUM_VOTE&countries=" + rus_id + "&type=MINI_SERIES",
            params,
            function (json) {
    ...
    menu({}, function () {
      ...
      priority_list.forEach(function (g) {
        ...
        if (id) {
          parts_data.push(function (call) {
            getList(
              "api/v2.2/films?order=NUM_VOTE&genres=" + id + "&type=" + (params.url == "tv" ? "TV_SERIES" : "FILM"),
              params,
              function (json) {
      ...
      menu_list.forEach(function (g) {
        if (!g.hide && !g.separator && priority_list.indexOf(g.title) == -1) {
          parts_data.push(function (call) {
            getList(
              "api/v2.2/films?order=NUM_VOTE&genres=" + g.id + "&type=" + (params.url == "tv" ? "TV_SERIES" : "FILM"),
              params,
              function (json) {
